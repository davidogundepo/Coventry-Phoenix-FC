...
class MostFouledYCPlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get mostFouledYCPlayersStatsAndInfoList =>
          UnmodifiableListView(_mostFouledYCPlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentMostFouledYCPlayersStatsAndInfo =>
      _currentMostFouledYCPlayersStatsAndInfo;

  set mostFouledYCPlayersStatsAndInfoList(
  ...
  set currentMostFouledYCPlayersStatsAndInfo(
