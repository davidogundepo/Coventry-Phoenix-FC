...
class MostAssistsPlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get mostAssistsPlayersStatsAndInfoList =>
          UnmodifiableListView(_mostAssistsPlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentMostAssistsPlayersStatsAndInfo =>
      _currentMostAssistsPlayersStatsAndInfo;

  set mostAssistsPlayersStatsAndInfoList(
  ...
  set currentMostAssistsPlayersStatsAndInfo(
