...
class FoundersReviewsCommentNotifier with ChangeNotifier {
  List<FoundersReviewsComment> _foundersReviewsCommentList =
      <FoundersReviewsComment>[];
  late FoundersReviewsComment _currentFoundersReviewsComment;

  UnmodifiableListView<FoundersReviewsComment> get foundersReviewsCommentList =>
      UnmodifiableListView(_foundersReviewsCommentList);

  FoundersReviewsComment get currentFoundersReviewsComment =>
      _currentFoundersReviewsComment;

  set foundersReviewsCommentList(
      List<FoundersReviewsComment> foundersReviewsCommentList) {
    _foundersReviewsCommentList = foundersReviewsCommentList;
    notifyListeners();
  }

  set currentFoundersReviewsComment(
