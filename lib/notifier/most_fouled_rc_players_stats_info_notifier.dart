...
class MostFouledRCPlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get mostFouledRCPlayersStatsAndInfoList =>
          UnmodifiableListView(_mostFouledRCPlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentMostFouledRCPlayersStatsAndInfo =>
      _currentMostFouledRCPlayersStatsAndInfo;

  set mostFouledRCPlayersStatsAndInfoList(
  ...
  set currentMostFouledRCPlayersStatsAndInfo(
