...
class TopGoalsPlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get topGoalsPlayersStatsAndInfoList =>
          UnmodifiableListView(_topGoalsPlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentTopGoalsPlayersStatsAndInfo =>
      _currentTopGoalsPlayersStatsAndInfo;

  set topGoalsPlayersStatsAndInfoList(
      List<PlayersStatsAndInfo> topGoalsPlayersStatsAndInfoList) {
    _topGoalsPlayersStatsAndInfoList = topGoalsPlayersStatsAndInfoList;
    notifyListeners();
  }

  set currentTopGoalsPlayersStatsAndInfo(
