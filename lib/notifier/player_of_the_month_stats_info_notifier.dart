...
class PlayerOfTheMonthStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get playerOfTheMonthStatsAndInfoList =>
          UnmodifiableListView(_playerOfTheMonthStatsAndInfoList);

  PlayersStatsAndInfo? get currentPlayerOfTheMonthStatsAndInfo =>
      _currentPlayerOfTheMonthStatsAndInfo;

  set playerOfTheMonthStatsAndInfoList(
  ...
  set currentPlayerOfTheMonthStatsAndInfo(
