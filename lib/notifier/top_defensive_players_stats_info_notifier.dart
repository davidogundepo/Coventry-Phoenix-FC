...
class TopDefensivePlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get topDefensivePlayersStatsAndInfoList =>
          UnmodifiableListView(_topDefensivePlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentTopDefensivePlayersStatsAndInfo =>
      _currentTopDefensivePlayersStatsAndInfo;

  set topDefensivePlayersStatsAndInfoList(
  ...
  set currentTopDefensivePlayersStatsAndInfo(
