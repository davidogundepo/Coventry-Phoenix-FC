...
class MySocialMediaPageState extends State<MySocialMediaPage> {
  ...
  String _instagram = 'CovPhoenixFC';
  String _twitter = 'CovPhoenixFC';
  String _facebook = 'CovPhoenixFC';
