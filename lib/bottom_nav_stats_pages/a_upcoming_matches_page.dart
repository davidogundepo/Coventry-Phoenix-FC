...
class UpcomingMatchesPageState extends State<UpcomingMatchesPage>
  ...
  Future navigateTablesAndStatsDetails(context) async {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => const PastMatchesPage()));
  }

  @override
  Widget build(BuildContext context) {
    UpcomingMatchesNotifier upcomingMatchesNotifier =
        Provider.of<UpcomingMatchesNotifier>(context);
                  ...
                  children: [
                    ...
                    Center(
                      ...
                      children: [
                        Text(
                            upcomingMatchesNotifier
                                .upcomingMatchesList[widget.index].matchDate!,
